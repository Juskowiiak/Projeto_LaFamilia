...
function info1() {
  const nome = document.querySelector(".special-info-name");
  const texto = document.querySelector(".special-info-texto");
  nome.innerHTML = "Double Chocolate Cake";
  texto.innerHTML =
...
function info2() {
  const nome = document.querySelector(".special-info-name");
  const texto = document.querySelector(".special-info-texto");
  nome.innerHTML = "Caramel Topped Ice Cream";
  texto.innerHTML =
...
function info3() {
  const nome = document.querySelector(".special-info-name");
  const texto = document.querySelector(".special-info-texto");
  nome.innerHTML = "Risoto de Queijo Parmesão";
  texto.innerHTML =
...
function info4() {
  const nome = document.querySelector(".special-info-name");
  const texto = document.querySelector(".special-info-texto");
  nome.innerHTML = "Risoto de Filé Mignon";
  texto.innerHTML =
...
function info5() {
  const nome = document.querySelector(".special-info-name");
  const texto = document.querySelector(".special-info-texto");
  nome.innerHTML = "Strogonoff de Camarão";
  texto.innerHTML =
